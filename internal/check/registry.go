...
func Registry() []RegistryEntry {
	return []RegistryEntry{
		...
		entry(Meta{ID: "dead-02", Domain: "dead-code", DefaultSeverity: SeverityInfo}, func() Checker { return NewDead02() }),
		entry(Meta{ID: "dead-03", Domain: "dead-code", DefaultSeverity: SeverityWarn}, func() Checker { return NewDead03() }),
		entry(Meta{ID: "dead-04", Domain: "dead-code", DefaultSeverity: SeverityWarn}, func() Checker { return NewDead04() }),
		entry(Meta{ID: "dead-05", Domain: "dead-code", DefaultSeverity: SeverityWarn}, func() Checker { return NewDead05() }),
		entry(Meta{ID: "dead-06", Domain: "dead-code", DefaultSeverity: SeverityWarn}, func() Checker { return NewDead06() }),
		entry(Meta{ID: "dead-07", Domain: "dead-code", DefaultSeverity: SeverityWarn}, func() Checker { return NewDead07() }),
		entry(Meta{ID: "dead-08", Domain: "dead-code", DefaultSeverity: SeverityInfo}, func() Checker { return NewDead08() }),
		...
		entry(Meta{ID: "sec-04", Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSec04() }),
		entry(Meta{ID: "sec-05", Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSec05() }),
		entry(Meta{ID: "sec-07", Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSec07() }),
		entry(Meta{ID: "sec-08", Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSec08() }),
		entry(Meta{ID: "sec-09", Domain: "security", DefaultSeverity: SeverityWarn}, func() Checker { return NewSec09() }),
		entry(Meta{ID: "sec-10", Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSec10() }),
		entry(Meta{ID: "sec-13", Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSec13() }),
		entry(Meta{ID: "sec-14", Gates: restGates(), Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSec14() }),
		entry(Meta{ID: "sec-15", Domain: "security", DefaultSeverity: SeverityWarn}, func() Checker { return NewSec15() }),
		entry(Meta{ID: "sec-16", Domain: "security", DefaultSeverity: SeverityWarn}, func() Checker { return NewSec16() }),
		entry(Meta{ID: "sec-r01", Gates: restGates(), Domain: "security", DefaultSeverity: SeverityWarn}, func() Checker { return NewSecR01() }),
		entry(Meta{ID: "sec-r03", Gates: restGates(), Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSecR03() }),
		entry(Meta{ID: "sec-r04", Gates: restGates(), Domain: "security", DefaultSeverity: SeverityWarn}, func() Checker { return NewSecR04() }),
		entry(Meta{ID: "sec-r05", Gates: restGates(), Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSecR05() }),
		entry(Meta{ID: "sec-r06", Gates: restGates(), Domain: "security", DefaultSeverity: SeverityWarn}, func() Checker { return NewSecR06() }),
		entry(Meta{ID: "sec-r09", Gates: restGates(), Domain: "security", DefaultSeverity: SeverityInfo}, func() Checker { return NewSecR09() }),
		entry(Meta{ID: "sec-r10", Gates: restGates(), Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSecR10() }),
		entry(Meta{ID: "sec-g01", Gates: gqlGates, Domain: "security", DefaultSeverity: SeverityWarn}, func() Checker { return NewSecG01() }),
		entry(Meta{ID: "sec-g02", Gates: gqlGates, Domain: "security", DefaultSeverity: SeverityWarn}, func() Checker { return NewSecG02() }),
		entry(Meta{ID: "sec-g03", Gates: gqlGates, Domain: "security", DefaultSeverity: SeverityWarn}, func() Checker { return NewSecG03() }),
		entry(Meta{ID: "sec-g04", Gates: gqlGates, Domain: "security", DefaultSeverity: SeverityWarn}, func() Checker { return NewSecG04() }),
		entry(Meta{ID: "sec-g05", Gates: gqlGates, Domain: "security", DefaultSeverity: SeverityWarn}, func() Checker { return NewSecG05() }),
		entry(Meta{ID: "sec-g06", Gates: gqlGates, Domain: "security", DefaultSeverity: SeverityWarn}, func() Checker { return NewSecG06() }),
		entry(Meta{ID: "sec-g07", Gates: gqlGates, Domain: "security", DefaultSeverity: SeverityWarn}, func() Checker { return NewSecG07() }),
		entry(Meta{ID: "sec-g08", Gates: gqlGates, Domain: "security", DefaultSeverity: SeverityWarn}, func() Checker { return NewSecG08() }),
		entry(Meta{ID: "sec-g09", Gates: gqlGates, Domain: "security", DefaultSeverity: SeverityInfo}, func() Checker { return NewSecG09() }),
		entry(Meta{ID: "sec-g10", Gates: gqlGates, Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSecG10() }),
		entry(Meta{ID: "sec-db01", Gates: sqlGates(), Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSecDB01() }),
		entry(Meta{ID: "sec-db02", Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSecDB02() }),
		entry(Meta{ID: "sec-db03", Gates: []string{"pgx"}, Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSecDB03() }),
		entry(Meta{ID: "sec-db05", Gates: sqlGates(), Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSecDB05() }),
		entry(Meta{ID: "sec-m01", Gates: mongoGates(), Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSecM01() }),
		entry(Meta{ID: "sec-m02", Gates: mongoGates(), Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSecM02() }),
		entry(Meta{ID: "sec-rd01", Gates: redisGates(), Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSecRD01() }),
		entry(Meta{ID: "sec-rd02", Gates: redisGates(), Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSecRD02() }),
		entry(Meta{ID: "sec-mq01", Gates: mqGates, Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSecMQ01() }),
		entry(Meta{ID: "sec-mq02", Gates: mqGates, Domain: "security", DefaultSeverity: SeverityFail}, func() Checker { return NewSecMQ02() }),
	}
}
